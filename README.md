...
|---|---|---|---|---|---|---|
| 保守型 | 5.54% | -3.53% | 0.89 | 0.86 | 90.1 万 | 73.3% |
| **稳健型** | **7.49%** | **-6.09%** | **0.91** | **0.89** | **110.1 万** | **67.9%** |
| 进取型 | 11.56% | -10.17% | 0.97 | 1.12 | 165.1 万 | 64.9% |
...
- **数据缺口**：月度收益序列末尾的 `2026-07` 标签对应日历 2026 年 8 月，该月尚未结束，暂用历史均值估计；其余 131 个月均为真实收益（已含 2026 年 7 月真实行情）。部分 ETF（红利 ETF、国债 ETF）尚未纳入基金池。
